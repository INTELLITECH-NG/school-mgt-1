    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                ...
                <!-- STUDENT RESULTSHEET -->
                <li class="<?php if ($page_name == 'student_scoresheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('student_scoreheet'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                        foreach ($classes as $row):
                            ?>
                            <li class="<?php if ($page_name == 'student_scoresheet' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a href="<?php echo base_url(); ?>index.php?admin/student_scoresheet/<?php echo $row['class_id']; ?>">
                                    <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
        ...
        <li class="<?php if ($page_name == 'class_timetable') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/class_timetable">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/marks">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('upload_results'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
