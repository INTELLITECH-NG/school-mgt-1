...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?admin/class_timetable/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-5">
                      <button type="submit" class="btn btn-info"><?php echo get_phrase('edit_class_timetable');?></button>
                  </div>
                </div>
        </form>
        <?php endforeach;?>
