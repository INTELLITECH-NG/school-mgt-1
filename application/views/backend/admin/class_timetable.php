		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('class_timetable_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('add_class_timetable');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
		...
		<div class="tab-content">
                                                    ...
                                                    <td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																<li>
                                                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_class_timetable/<?php echo $row2['class_routine_id'];?>');">
                                                         ...
                                                         <li>
                                                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/class_table/delete/<?php echo $row2['class_routine_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/class_timetable/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo get_phrase('add_class_timetable');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
